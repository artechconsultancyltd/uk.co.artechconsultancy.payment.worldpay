...
class CRM_Core_Payment_WorldpayStd extends CRM_Core_Payment {
    ...
    public static function &singleton($mode = 'test', &$paymentProcessor, &$paymentForm = null, $force = false) {
        ...
        self::$_singleton[$processorName] = new CRM_Core_Payment_WorldpayStd($mode, $paymentProcessor);
    ...
    public function doTransferCheckout(&$params, $component = 'contribute') {
      ...
      */
      ...
      $url    = ( $component == 'event' ) ? 'civicrm/event/register' : 'commerce/worldpay/bg/response';
	...
	CRM_Core_Error::debug_log_message( 'returnURL = '. print_r($returnURL,true), $out = false );	
  ...
  /**
    ...
    public function handlePaymentNotification() {
        ...
        $ipn = new CRM_Core_Payment_WorldpayStdIPN($this);
        $ipn->main(false);
    }
    ...
    protected function getIDs() {
        ...
        $dao = CRM_Core_DAO::executeQuery("
            SELECT id FROM civicrm_payment_processor
             WHERE class_name = 'CRM_Core_Payment_Worldpay'
        ");
        while ($dao->fetch())
            $ids[] = $dao->id;
        return $ids;
